...
export class ArticlesApiService {
  ...
  getAllArticles(): Observable<Article[]> {
    let allArticlesUrl = `${this.articleHost}/article-api/public/articles`
  ...
  public getArticleByPmid(articleId) : Observable<Article>{
    let url = `${this.articleHost}/article-api/public/article/pmid/${articleId}`
    return this.httpClient.get<Article>(url);
  }

  public getArticleByTitle(wordTitle) : Observable<Article[]>{
    let url = `${this.articleHost}/article-api/public/articles/title/${wordTitle}`
    return this.httpClient.get<Article[]>(url);
  }
  ...
  public getArticleByAbstract(wordAbstract) : Observable<Article[]>{
    let url = `${this.articleHost}/article-api/public/articles/abstract/${wordAbstract}`
    return this.httpClient.get<Article[]>(url);
  }
  ...
  public getArticleByAuthor(author) : Observable<Article[]>{
    let url = `${this.articleHost}/article-api/public/articles/author/${author}`
    return this.httpClient.get<Article[]>(url);
  }
}
